          ...
          return (
            ...
            >
              ...
              <div className="absolute right-3 top-1/2 -translate-y-1/2 flex gap-1.5 bg-black/40 backdrop-blur-sm p-1 rounded-xl border border-white/5">
                ...
                <button onClick={(e) => { e.stopPropagation(); onRemove(asset.id); }} className="p-2 bg-white/5 rounded-lg hover:bg-red-500/20 text-white/40 hover:text-red-500 transition-all active:scale-95" title="Excluir"><Trash2 size={14} /></button>
              </div>
            </div>
          );
        })}
